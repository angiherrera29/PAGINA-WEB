...
const carrito = document.getElementById("Carrito"),
      listaCursos = document.getElementById("lista_de_cursos"),
...
function eliminarCurso(e) {
   if (e.target.classList.contains("borrar-curso")) {
      ...
      // Eliminar del arreglo de artículos del carrito por el data-id
...
// Leer el contenido de nuestro HTML al que le dimos click y extraer la info del curso
...
function carritoHTML() {
   ...
   articulosCarrito.forEach(curso => {
      ...
      fila.innerHTML = `
         <img src="${curso.imagen}" alt="${curso.titulo}"></img>
         <p>${curso.titulo}</p>
         <p>${curso.precio}</p>
         <p>${curso.cantidad}</p>
